...
MONGODB_CONNECTION_STRING = "mongodb+srv://test:sparta@cluster0.voyyor4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
    ...
    try:
        ...
        for post in posts:
            ...
            post["count_thumbsup"] = db.likes.count_documents(
                {"post_id": post["_id"], "type": "thumsbsup"}
            )
